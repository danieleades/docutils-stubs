...
class Node:
    ...
    @overload
    def traverse(
        self, condition: Type[N] = ..., include_self: bool = ..., descend: bool = ..., siblings: bool = ..., ascend: bool = ...
    ) -> List[N]: ...
    @overload  # NOQA: F811
    def traverse(
        self,
...
class Element(Node):
    ...
    def update_all_atts(
        self, dict_, update_fun: Callable[[str, Any, bool], None] = ..., replace: bool = ..., and_source: bool = ...
    ) -> None: ...
...
class document(Root, Structural, Element):
    ...
    def set_name_id_map(
        self, node: Element, id: str, msgnode: Optional[Element] = ..., explicit: Optional[bool] = ...
    ) -> None: ...
    ...
    def note_substitution_def(
        self, subdef: "substitution_definition", def_name: str, msgnode: Optional[Element] = ...
    ) -> None: ...
...
class pending(Special, Invisible, Element):
    ...
    details: Dict = ...
    def __init__(
        self, transform: Transform, details: Optional[Dict] = ..., rawsource: str = ..., *children: Node, **attributes: Any
    ) -> None: ...
    def pformat(self, indent: str = ..., level: int = ...) -> str: ...
    def copy(self: N) -> N: ...
