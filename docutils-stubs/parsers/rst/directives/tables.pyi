...
class CSVTable(Table):
    ...
    def parse_csv_data_into_rows(
        self, csv_data: List[str], dialect: Any, source: str
    ) -> Tuple[List[Tuple[int, int, int, StringList]], int]: ...
...
class ListTable(Table):
    ...
    def build_table_from_list(
        self, table_data: List[List[N_co]], col_widths: List[int], header_rows: int, stub_columns: int
    ) -> table: ...
