...
def role(
    role_name: str, language_module: ModuleType, lineno: int, reporter: Reporter
...
def generic_custom_role(
    role: str, rawtext: str, text: str, lineno: int, inliner: Inliner, options: Dict[str, Any] = ..., content: List[str] = ...
) -> Tuple[List[Node], List[system_message]]: ...
...
def unimplemented_role(
    role: str, rawtext: str, text: str, lineno: int, inliner: Inliner, attributes: Dict[str, Any] = ...
) -> Tuple[List[Node], List[system_message]]: ...
