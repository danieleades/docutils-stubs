...
class RSTState(StateWS):
    ...
    def no_match(
        self, context, transitions: Tuple[List[str], Dict[str, Tuple[Pattern, Callable, str]]]
    ) -> Tuple[Any, str, List]: ...
    ...
    def nested_parse(
        ...
        node: nodes.Node,
        match_titles: bool = ...,
        state_machine_class: Optional[Type[StateMachine]] = ...,
        state_machine_kwargs: Optional[Dict[str, Any]] = ...,
    ) -> int: ...
    def nested_list_parse(
        ...
        initial_state,
        blank_finish,
        blank_finish_state: Optional[Any] = ...,
        extra_settings: Any = ...,
        match_titles: bool = ...,
        state_machine_class: Optional[Any] = ...,
        state_machine_kwargs: Optional[Any] = ...,
    ) -> Tuple[int, bool]: ...
...
class Inliner:
    ...
    def inline_obj(
        self, match: Match, lineno: int, end_pattern: Pattern, nodeclass: nodes.TextElement, restore_backslashes: bool = ...
    ...
    def reference(
        self, match: Match, lineno: int, anonymous: bool = ...
    ) -> Tuple[str, List[nodes.problematic], str, List[nodes.system_message]]: ...
...
class Body(RSTState):
    ...
    ) -> Tuple[StringList, Optional[StringList], Optional[int], Optional[StringList], Optional[int]]: ...
    ...
    def table_top(
        ...
        isolate_function: Callable[
            [], Union[Tuple[List[Any], List[nodes.system_message], bool], Tuple[StringList, List[nodes.system_message], bool]]
        ],
        parser_class: Union[Type[tableparser.GridTableParser], Type[tableparser.SimpleTableParser]],
    ) -> Tuple[List[Any], str, List[Any]]: ...
    def table(
        self,
        isolate_function: Callable[[], Tuple[Union[List[Any], StringList], List[nodes.system_message], bool]],
        parser_class: Union[Type[tableparser.GridTableParser], Type[tableparser.SimpleTableParser]],
    ...
    def build_table(
        ...
        tableline: int,
        stub_columns: int = ...,
        widths: Union[None, str, List[int]] = ...,
    ) -> nodes.table: ...
    ...
    def substitution_def(
        self, match: Match
    ) -> Union[Tuple[List[nodes.system_message], bool], Tuple[List[nodes.substitution_definition], bool]]: ...
    def disallowed_inside_substitution_definitions(self, node: nodes.Node) -> int: ...
    def directive(
        self, match: Match, **option_presets: Any
    ) -> Union[
        Tuple[List[nodes.system_message], bool], Tuple[List[nodes.literal_block], bool], Tuple[List[nodes.system_message], bool]
    ]: ...
    def run_directive(
        self, directive: Type[Directive], match: Match, type_name: str, option_presets: Dict[str, Any]
    ) -> Union[Tuple[List[nodes.system_message], bool], Tuple[List[nodes.literal_block], bool]]: ...
    ...
    def parse_directive_options(
        ...
        arg_block: Union[StringList, List[Any]],
    ...
    def parse_extension_options(
        self, option_spec: Dict[str, Callable[[str], str]], datalines: Union[StringList, List[Any]]
    ...
    def explicit_construct(
        ...
        Tuple[List[Union[nodes.comment, nodes.system_message]], bool],
    ]: ...
...
class SpecializedBody(Body):
    def invalid_input(
        self, match: Optional[Match] = ..., context: Optional[Any] = ..., next_state: Optional[str] = ...
    ) -> None: ...
...
class Text(RSTState):
    ...
    ) -> Tuple[List[Union[nodes.term, nodes.classifier]], List[nodes.system_message]]: ...
