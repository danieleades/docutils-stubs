...
BasicDefinition: TypeAlias = Tuple[str, str, str, List[Pattern]]
DefinitionParts: TypeAlias = Tuple[str, str, str, List[Union[Pattern, BasicDefinition]]]
DefinitionType: TypeAlias = Tuple[str, str, str, List[Union[Pattern, DefinitionParts]]]
...
class Inliner:
    ...
    def phrase_ref(self, before: str, after: str, rawsource: str, escaped: str, text: str | None = None) -> Tuple[str, List[nodes.Node], str, List[nodes.Node]]: ...
