...
class StateMachine:
    ...
    def run(
        self,
        input_lines: Union[List[str], "StringList"],
        input_offset: int = ...,
...
class State:
    ...
    def make_transitions(
        self, name_list: List[Union[str, Tuple[str], Tuple[str, str]]]
    ) -> Tuple[List[str], Dict[str, Tuple[Pattern, Callable, str]]]: ...
    def no_match(
...
class StateMachineWS(StateMachine):
    ...
    def get_known_indented(
        self, indent: int, until_blank: bool = ..., strip_indent: bool = ...
    ) -> Tuple[List[str], int, bool]: ...
    def get_first_known_indented(
        self, indent: int, until_blank: bool = ..., strip_indent: bool = ..., strip_top: bool = ...
...
class ViewList:
    ...
    def __init__(
        self,
        initlist: Optional[Union["ViewList", List]] = ...,
        source: Optional[str] = ...,
        items: Optional[List[Tuple[str, int]]] = ...,
        parent: Optional["ViewList"] = ...,
        parent_offset: Optional[int] = ...,
    ) -> None: ...
