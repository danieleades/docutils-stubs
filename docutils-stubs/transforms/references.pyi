...
from docutils.transforms import Transform, references
...
class Footnotes(Transform):
    ...
    def resolve_references(
        self, note: Union[nodes.footnote, nodes.citation], reflist: Union[nodes.footnote_reference, nodes.citation_reference]
    ) -> None: ...
