...
def Element(
    tag: str, attrib: Optional[Dict[str, Any]] = ..., nsmap: Optional[Any] = ..., nsdict: Mapping[str, str] = ...
...
class Writer(writers.Writer):
    ...
    def update_stylesheet(
        self, stylesheet_root: _ElementInterfaceWrapper, language_code: str, region_code: str
    ) -> Tuple[bool, _ElementInterfaceWrapper, Set[_ElementInterfaceWrapper]]: ...
...
class ODFTranslator(nodes.GenericNodeVisitor):
    ...
    def create_custom_headfoot(
        self, parent: _ElementInterfaceWrapper, text: str, style_name: str, automatic_styles: _ElementInterfaceWrapper
    ) -> None: ...
    def make_field_element(
        self, parent: _ElementInterfaceWrapper, text: str, style_name: str, automatic_styles: _ElementInterfaceWrapper
    ) -> Optional[_ElementInterfaceWrapper]: ...
    ...
    def append_child(
        self, tag: str, attrib: Optional[Dict[str, Any]] = ..., parent: Optional[_ElementInterfaceWrapper] = ...
    ) -> _ElementInterfaceWrapper: ...
    ...
    def get_image_width_height(
        self, node: nodes.Node, attr: str
    ) -> Union[Tuple[None, None], Tuple[float, str], Tuple[str, None]]: ...
    ...
    def generate_figure(
        self, node: nodes.Node, source: str, destination: Any, current_element: _ElementInterfaceWrapper
    ) -> Tuple[_ElementInterfaceWrapper, _ElementInterfaceWrapper, _ElementInterfaceWrapper, Optional[str]]: ...
    def generate_image(
        self,
        node: nodes.Node,
        source: str,
        destination: str,
        current_element,
        frame_attrs: Optional[MutableMapping[str, str]] = ...,
    ) -> Tuple[_ElementInterfaceWrapper, str]: ...
    ...
    def update_toc_collect(
        self, el: _ElementInterfaceWrapper, level: int, collection: MutableSequence[Tuple[int, _ElementInterfaceWrapper]]
    ) -> None: ...
