...
class Container:
    ...
    def locateprocess(
        self, locate: Callable[["Container"], bool], process: Callable[["Container"], List["Container"]]
    ) -> None: ...
    def recursivesearch(
        self,
        locate: Callable[["Container"], bool],
        recursive: Callable[["Container"], bool],
        process: Callable[["Container"], None],
    ) -> None: ...
